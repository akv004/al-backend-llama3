...
# ---------- CLI ----------
p = argparse.ArgumentParser(description="Llama 3 chat with cache auto-resolve (RTX 5090 friendly)")
...
# ---------- Torch knobs (good for 5090) ----------
torch.backends.cuda.matmul.fp32_precision = "tf32"  # speed; use 'ieee' for strict
...
# If chat template missing, inject Llama 3 template
